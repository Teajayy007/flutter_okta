...
// package com.example.flutter_okta_sdk
...
//     channel = MethodChannel(flutterPluginBinding.binaryMessenger, "flutter_okta_sdk")
...
import androidx.annotation.NonNull
import com.example.flutter_okta_sdk.okta.entities.*
import com.example.flutter_okta_sdk.okta.operations.*
import io.flutter.embedding.engine.plugins.FlutterPlugin
...
class FlutterOktaSdkPlugin : FlutterPlugin, MethodCallHandler,
    ...
    private fun onAttachedToEngine(context: Context, binaryMessenger: BinaryMessenger) {
        ...
        channel = MethodChannel(binaryMessenger, "flutter_okta_sdk")
        channel.setMethodCallHandler(this)
    }
}
